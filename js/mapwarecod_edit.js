...
function initialize() {
   //Đọc thiết lập menu từ file XML
    //Tạo menu cha
    downloadUrl("./data/xml/menu.xml", function(data) {
     ...
     if(typeLayers[index] != "Raster")
     {
        ...
        //Sự kiện click vào đối tượng dạng vùng và dạng điểm
         layers[index].addListener('click', function(event) {
          ...
          {
             var info = '<div id="iw-container"><div class="iw-title">THÔNG TIN</div><div class="iw-content">';
...
function chonLuuVuc(index)
{
     ...
     //alert(getAttribute(menus[index],"Id"));
      ...
      switch(index) {
         case 0:
            fileConfig = "./data/xml/layerKycung.xml";
            //alert(fileConfig);
            loadLuuVuc(fileConfig);
            break;
         case 1:
            fileConfig = "./data/xml/layerHong_TB.xml";
            loadLuuVuc(fileConfig);
            break;
         case 2:
            fileConfig = "./data/xml/layerMa.xml";
            //alert(fileConfig);
            loadLuuVuc(fileConfig);
            break;
         case 3:
            fileConfig = "./data/xml/layerCa.xml";
            //alert(fileConfig);
            loadLuuVuc(fileConfig);
            break;
         case 4:
            fileConfig = "./data/xml/layerHuong.xml";
            //alert(fileConfig);
            loadLuuVuc(fileConfig);
            break;
         case 5:
            fileConfig = "./data/xml/layerVugia.xml";
            //alert(fileConfig);
            loadLuuVuc(fileConfig);
            break;
         case 6:
            fileConfig = "./data/xml/layerBa.xml";
            //alert(fileConfig);
            loadLuuVuc(fileConfig);
            break;
         case 7:
            fileConfig = "./data/xml/layerSerepok.xml";
            loadLuuVuc(fileConfig);
            break;
         case 8:
            fileConfig = "./data/xml/layerDongnai.xml";
            //alert(fileConfig);
            loadLuuVuc(fileConfig);
            break;
         case 9:
            fileConfig = "./data/xml/layerCuulong.xml";
            //alert(fileConfig);
            loadLuuVuc(fileConfig);
            break;
         case 10:
            fileConfig = "./data/xml/layerNamTB.xml";
            //alert(fileConfig);
            loadLuuVuc(fileConfig);
            break;
         default:
            alert("Chưa có dữ liệu lưu vực này!");
            break;
      }
}
